...
RSpec.describe "Customers", type: :request do
  ...
  describe "GET /customers/:id" do
    it "renders the Documents section with the customer's documents and an upload form" do
      customer = create(:customer)
      create(:document, documentable: customer, label: "Signed contract")
      get customer_path(customer)

      expect(response.body).to include("Signed contract")
      expect(response.body).to include(%(action="#{customer_documents_path(customer)}"))
    end
